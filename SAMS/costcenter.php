...
<head>
	...
	<!-- JavaScripts -->
	<script src="scripts/costcenter.js"></script>
	...
	<section id="content">
		...
		<nav>
			...
			<form action="#">
				...
				<input class="dept-search" type="search" id="ccenter-sch" name="search_department" placeholder="Search Cost Center" >
